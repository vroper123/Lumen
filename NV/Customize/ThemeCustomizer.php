...
class ThemeCustomizer {
	...
	public static function register( $wp_customize ) {
		...
		/*
		$wp_customize->add_section( 'lumen_theme_options',
		  array(
			  'title'         => __( 'Lumen Options', 'nvLangScope' ),
			  'priority'      => 35,
			  'capability'    => 'edit_theme_options',
			  'description'   => __('Allows you to customize some example settings for Lumen.', 'nvLangScope'),
		  )
		);
		*/
		...
		$wp_customize->add_setting(
			'lumen_theme_options[link_textcolor]',    // Give it a SERIALIZED name (so all theme settings can live under one db record)
			[                                      // Pass an args array...
		...
		$wp_customize->add_control(
			new \WP_Customize_Color_Control(                                // Instantiate the color control class
				...
				'lumen_link_textcolor',                                   // Set a unique ID for the control
				[                                                      // Pass an args array....
					'label'    => __( 'Link Color', 'nvLangScope' ),        // Admin-visible name of the control
					'section'  => 'colors',                                 // ID of the section this control should render in (can be one of yours, or a WordPress default section)
					'settings' => 'lumen_theme_options[link_textcolor]',  // Which setting to load and manipulate (serialized is okay)
		...
		// Radio button list...
		/*
		$wp_customize->add_control( 'lumen_example_radio_list', array(  // Unique id for the control
			'label'     => __( 'Example Radio List', 'nvLangScope' ),     // Admin-visible name of the control
			'section'   => 'lumen_theme_options',                       // Which pre-defined section does this control go in?
			'settings'  => 'lumen_theme_options[container_bg_color]',   // What is the serialized name of this option?
	...
	public static function header_output() {
		...
		<style type="text/css">
			...
			<?php self::generate_css( 'a', 'color', 'lumen_theme_options[link_textcolor]' ); ?>
		</style>
		<!--/Customizer CSS-->
		<?php
	}
	...
	public static function live_preview() {
		wp_enqueue_script(
			'lumen-themecustomizer', //Give the script an ID
