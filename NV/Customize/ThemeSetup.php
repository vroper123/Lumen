...
class ThemeSetup {
	...
	public static function after_setup_theme() {
		 ...
		 */
//		add_option( 'lumen_example_checkbox' );
//		add_option( 'lumen_example_radio' );
//		add_option( 'lumen_example_text', 'This is example default text.' );
//		add_option( 'lumen_example_select' );
